...
public:
	...
	ObjectPool(unsigned int defaultSize = 32, ObjectPoolConstructFunctionType construct = NULL, ObjectPoolDestructFunctionType destruct = NULL);
	~ObjectPool();
...
template <class T>
ObjectPool<T>::ObjectPool(unsigned int defaultSize, ObjectPoolConstructFunctionType construct, ObjectPoolDestructFunctionType destruct) {
