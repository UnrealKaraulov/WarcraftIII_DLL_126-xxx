...
unsigned int Button::indexTotal = 0;

void Button_EventHandler(Observer* ob, unsigned int evtId) {
...
void Button::setRelativePosition(unsigned int originPos, UILayoutFrame* target, unsigned int toPos, float relativeX, float relativeY) {
