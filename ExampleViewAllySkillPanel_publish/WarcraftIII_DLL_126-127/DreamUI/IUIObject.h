...
public:
	...
	virtual void 			setAbsolutePosition ( uint32_t originPos, float absoluteX, float absoluteY ) = 0;
	virtual void 			setRelativePosition ( uint32_t originPos, IUIObject* target, uint32_t toPos, float relativeX = 0, float relativeY = 0 ) = 0;
	virtual void 			setRelativePosition ( uint32_t originPos, UILayoutFrame* target, uint32_t toPos, float relativeX = 0, float relativeY = 0 ) = 0;
